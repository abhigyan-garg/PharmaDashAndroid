...
public class DriverSettingsActivity extends AppCompatActivity {
    ...
    private void saveUserInformation() {
        ...
        if (mName.equals(""))
            ...
            Toast.makeText(getApplicationContext(), "Please enter your car make and model", Toast.LENGTH_LONG).show();
        else if (resultUri == null && mProfileImageUrl == null)
            Toast.makeText(getApplicationContext(), "Please choose a profile image", Toast.LENGTH_LONG).show();
        else {
